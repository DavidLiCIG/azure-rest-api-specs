...
namespace foo.bar
{
    ...
    public static partial class FaceExtensions
    {
            ...
            /// </param>
            public static IList<SimilarFace> FindSimilar(this IFace operations, System.Guid faceId, string faceListId = default(string), string largeFaceListId = default(string), IList<System.Guid?> faceIds = default(IList<System.Guid?>), int? maxNumOfCandidatesReturned = 20, FindSimilarMatchMode mode = default(FindSimilarMatchMode))
            {
                return operations.FindSimilarAsync(faceId, faceListId, largeFaceListId, faceIds, maxNumOfCandidatesReturned, mode).GetAwaiter().GetResult();
            }
            ...
            /// faces
            /// </param>
            public static GroupResult Group(this IFace operations, IList<System.Guid> faceIds)
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<GroupResult> GroupAsync(this IFace operations, IList<System.Guid> faceIds, CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// </param>
            public static IList<IdentifyResult> Identify(this IFace operations, IList<System.Guid> faceIds, string personGroupId = default(string), string largePersonGroupId = default(string), int? maxNumOfCandidatesReturned = 1, double? confidenceThreshold = default(double?))
            {
                return operations.IdentifyAsync(faceIds, personGroupId, largePersonGroupId, maxNumOfCandidatesReturned, confidenceThreshold).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<IList<IdentifyResult>> IdentifyAsync(this IFace operations, IList<System.Guid> faceIds, string personGroupId = default(string), string largePersonGroupId = default(string), int? maxNumOfCandidatesReturned = 1, double? confidenceThreshold = default(double?), CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// </param>
            public static VerifyResult VerifyFaceToFace(this IFace operations, System.Guid faceId1, System.Guid faceId2)
            {
                return operations.VerifyFaceToFaceAsync(faceId1, faceId2).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<VerifyResult> VerifyFaceToFaceAsync(this IFace operations, System.Guid faceId1, System.Guid faceId2, CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// </param>
            public static IList<DetectedFace> DetectWithUrl(this IFace operations, string url, bool? returnFaceId = true, bool? returnFaceLandmarks = false, IList<FaceAttributeType> returnFaceAttributes = default(IList<FaceAttributeType>))
            {
                return operations.DetectWithUrlAsync(url, returnFaceId, returnFaceLandmarks, returnFaceAttributes).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<IList<DetectedFace>> DetectWithUrlAsync(this IFace operations, string url, bool? returnFaceId = true, bool? returnFaceLandmarks = false, IList<FaceAttributeType> returnFaceAttributes = default(IList<FaceAttributeType>), CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// the same time.
            /// </param>
            public static VerifyResult VerifyFaceToPerson(this IFace operations, System.Guid faceId, System.Guid personId, string personGroupId = default(string), string largePersonGroupId = default(string))
            {
                return operations.VerifyFaceToPersonAsync(faceId, personId, personGroupId, largePersonGroupId).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<VerifyResult> VerifyFaceToPersonAsync(this IFace operations, System.Guid faceId, System.Guid personId, string personGroupId = default(string), string largePersonGroupId = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// computational and time cost.
            /// </param>
            public static IList<DetectedFace> DetectWithStream(this IFace operations, Stream image, bool? returnFaceId = true, bool? returnFaceLandmarks = false, IList<FaceAttributeType> returnFaceAttributes = default(IList<FaceAttributeType>))
            {
                return operations.DetectWithStreamAsync(image, returnFaceId, returnFaceLandmarks, returnFaceAttributes).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<IList<DetectedFace>> DetectWithStreamAsync(this IFace operations, Stream image, bool? returnFaceId = true, bool? returnFaceLandmarks = false, IList<FaceAttributeType> returnFaceAttributes = default(IList<FaceAttributeType>), CancellationToken cancellationToken = default(CancellationToken))
            {
