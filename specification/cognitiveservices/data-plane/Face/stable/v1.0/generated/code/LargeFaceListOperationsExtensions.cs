...
namespace foo.bar
{
    ...
    public static partial class LargeFaceListOperationsExtensions
    {
            ...
            /// </param>
            public static void Create(this ILargeFaceListOperations operations, string largeFaceListId, string name = default(string), string userData = default(string))
            {
                operations.CreateAsync(largeFaceListId, name, userData).GetAwaiter().GetResult();
            }
            ...
            /// Id referencing a particular large face list.
            /// </param>
            public static LargeFaceList Get(this ILargeFaceListOperations operations, string largeFaceListId)
            {
                return operations.GetAsync(largeFaceListId).GetAwaiter().GetResult();
            }
            ...
            /// User specified data. Length should not exceed 16KB.
            /// </param>
            public static void Update(this ILargeFaceListOperations operations, string largeFaceListId, string name = default(string), string userData = default(string))
            {
                operations.UpdateAsync(largeFaceListId, name, userData).GetAwaiter().GetResult();
            }
            ...
            /// Id referencing a particular large face list.
            /// </param>
            public static void Delete(this ILargeFaceListOperations operations, string largeFaceListId)
            {
                operations.DeleteAsync(largeFaceListId).GetAwaiter().GetResult();
            }
            ...
            /// Id referencing a particular large face list.
            /// </param>
            public static TrainingStatus GetTrainingStatus(this ILargeFaceListOperations operations, string largeFaceListId)
            {
                return operations.GetTrainingStatusAsync(largeFaceListId).GetAwaiter().GetResult();
            }
            ...
            /// The operations group for this extension method.
            /// </param>
            public static IList<LargeFaceList> List(this ILargeFaceListOperations operations)
            {
            ...
            /// Id referencing a particular large face list.
            /// </param>
            public static void Train(this ILargeFaceListOperations operations, string largeFaceListId)
            {
                operations.TrainAsync(largeFaceListId).GetAwaiter().GetResult();
            }
            ...
            /// </param>
            public static void DeleteFace(this ILargeFaceListOperations operations, string largeFaceListId, System.Guid persistedFaceId)
            {
                operations.DeleteFaceAsync(largeFaceListId, persistedFaceId).GetAwaiter().GetResult();
            }
            ...
            /// Id referencing a particular persistedFaceId of an existing face.
            /// </param>
            public static PersistedFace GetFace(this ILargeFaceListOperations operations, string largeFaceListId, System.Guid persistedFaceId)
            {
                return operations.GetFaceAsync(largeFaceListId, persistedFaceId).GetAwaiter().GetResult();
            }
            ...
            /// </param>
            public static void UpdateFace(this ILargeFaceListOperations operations, string largeFaceListId, System.Guid persistedFaceId, string userData = default(string))
            {
                operations.UpdateFaceAsync(largeFaceListId, persistedFaceId, userData).GetAwaiter().GetResult();
            }
            ...
            /// </param>
            public static PersistedFace AddFaceFromUrl(this ILargeFaceListOperations operations, string largeFaceListId, string url, string userData = default(string), IList<int> targetFace = default(IList<int>))
            {
                return operations.AddFaceFromUrlAsync(largeFaceListId, url, userData, targetFace).GetAwaiter().GetResult();
            }
            ...
            /// 'start' parameter.
            /// </param>
            public static IList<PersistedFace> ListFaces(this ILargeFaceListOperations operations, string largeFaceListId, string start = default(string), int? top = default(int?))
            {
                return operations.ListFacesAsync(largeFaceListId, start, top).GetAwaiter().GetResult();
            }
            ...
            /// there is only one face detected in the entire image.
            /// </param>
            public static PersistedFace AddFaceFromStream(this ILargeFaceListOperations operations, string largeFaceListId, Stream image, string userData = default(string), IList<int> targetFace = default(IList<int>))
            {
                return operations.AddFaceFromStreamAsync(largeFaceListId, image, userData, targetFace).GetAwaiter().GetResult();
            }
