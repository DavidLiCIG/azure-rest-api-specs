...
namespace foo.bar
{
    ...
    public static partial class SnapshotOperationsExtensions
    {
            ...
            /// exceed 16KB.
            /// </param>
            public static SnapshotTakeHeaders Take(this ISnapshotOperations operations, SnapshotObjectType type, string objectId, IList<System.Guid> applyScope, string userData = default(string))
            {
                return operations.TakeAsync(type, objectId, applyScope, userData).GetAwaiter().GetResult();
            }
            ...
            /// </param>
            public static IList<Snapshot> List(this ISnapshotOperations operations, SnapshotObjectType? type = default(SnapshotObjectType?), IList<System.Guid> applyScope = default(IList<System.Guid>))
            {
                return operations.ListAsync(type, applyScope).GetAwaiter().GetResult();
            }
            ...
            /// </param>
            public static Snapshot Get(this ISnapshotOperations operations, System.Guid snapshotId)
            {
                return operations.GetAsync(snapshotId).GetAwaiter().GetResult();
            }
            ...
            /// exceed 16KB.
            /// </param>
            public static void Update(this ISnapshotOperations operations, System.Guid snapshotId, IList<System.Guid> applyScope = default(IList<System.Guid>), string userData = default(string))
            {
                operations.UpdateAsync(snapshotId, applyScope, userData).GetAwaiter().GetResult();
            }
            ...
            /// Id referencing a particular snapshot.
            /// </param>
            public static void Delete(this ISnapshotOperations operations, System.Guid snapshotId)
            {
                operations.DeleteAsync(snapshotId).GetAwaiter().GetResult();
            }
            ...
            /// include: 'CreateNew'
            /// </param>
            public static SnapshotApplyHeaders Apply(this ISnapshotOperations operations, System.Guid snapshotId, string objectId, SnapshotApplyMode mode = default(SnapshotApplyMode))
            {
                return operations.ApplyAsync(snapshotId, objectId, mode).GetAwaiter().GetResult();
            }
            ...
            /// </param>
            public static OperationStatus GetOperationStatus(this ISnapshotOperations operations, System.Guid operationId)
            {
